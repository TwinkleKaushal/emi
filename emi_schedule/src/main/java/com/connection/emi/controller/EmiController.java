...
public class EmiController {
	...
	public ResponseEntity<EmiResponseModel> emiCalculator(@RequestBody String emidto) throws Exception {
		LoggingResponseModel msgStart = LoggingResponseModel.builder().message("Inside controller to calculate EMI")
                .build();
	...
	public ResponseEntity<EmiPauseResponseModel> emiGenetarion(@RequestBody String pauseDto) throws Exception {
		LoggingResponseModel msgStart = LoggingResponseModel.builder().message("Inside controller to calculate EMI Pause")
                .build();
        log.info(gson.toJson(msgStart));
